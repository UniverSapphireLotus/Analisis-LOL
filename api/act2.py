# -*- coding: utf-8 -*-
"""
Created on Sat Nov 27 12:55:09 2021
...
for i, series in vi.iterrows():
    ...
    call= 'https://americas.api.riotgames.com/lol/match/v5/matches/by-puuid/'+series['puuid']+'/ids?type=ranked&start=0&count=20&api_key=' + my_api
